    ...
    (
      ...
      >
        <div style={{ display: "flex", flexDirection: "column" }}>
          <div style={{ color: "#5C6170", fontSize: "24px", marginBottom: "32px", display: "flex" }}>
            {siteConfig.domain}
          </div>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <div style={{ color: "#C9B06B", fontSize: "28px", fontWeight: 700, display: "flex" }}>View my work →</div>
          <div style={{ color: "#5C6170", fontSize: "24px", display: "flex" }}>
            {siteConfig.domain}
          </div>
        </div>
      </div>
