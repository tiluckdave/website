...
I was a big fan of [axios](https://axios-http.com/) for fetching data. I never wanted to try anything else untill I found Lee Robinson talk about SWR in hin course [React 2025](https://www.react2025.com). I gave it a try and it is the best library for data fetching.
