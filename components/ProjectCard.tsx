...
export default function ProjectCard({ title, url, github, desc }) {
  return (
    <div className="flex flex-col items-center border border-zinc-200 dark:border-zinc-800 p-4 w-full rounded-md transition-all text-zinc-700 dark:text-zinc-300">
      <div className="flex justify-between items-center w-full">
        <h4 className="text-lg md:text-lg font-medium">{title}</h4>
      ...
      <p className="text-sm md:text-base text-zinc-500 dark:text-zinc-400 mt-4">
        {desc}
      </p>
    </div>
  );
