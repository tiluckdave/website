...
export default function ProjectCard({ title, url, github, desc }) {
  return (
    <div className="flex flex-col items-center bg-zinc-200 dark:bg-zinc-800 p-4 w-full rounded-md transition-all text-zinc-700 dark:text-zinc-300 hover:ring-1 hover:ring-zinc-500 transition-all">
      ...
      <div className='flex gap-2'>
        ...
        <a href={url}
          ...
          className="bg-zinc-100 rounded-lg dark:bg-zinc-900 w-9 h-9 transition-all text-zinc-800 dark:text-zinc-50 flex items-center justify-center hover:scale-90">
      ...
      <p className="text-sm md:text-base text-zinc-500 dark:text-zinc-400 mt-4">{desc}</p>
    </div>
